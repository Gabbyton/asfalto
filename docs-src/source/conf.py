    ...
    "icon_links": [
        {
            ...
            "url": "https://github.com/cwru-sdle/asfalto/",  # required
        ...
        },
        {
            ...
            "name": "PyPI",
            # URL where the link will redirect
            "url": "https://pypi.org/project/asfalto/",  # required
            # Icon class (if "type": "fontawesome"), or path to local image (if "type": "local")
...
html_baseurl = "https://cwru-sdle.github.io/asfalto/"
